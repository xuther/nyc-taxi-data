...
tractsPath = censusBasePath+"Tracts/tl_2010_36_tract10Culled"
blockPath = censusBasePath+"Blocks/tl_2010_36_tabblock10Culled"
...
print str(len(blocks.records())) + " blocks mapped."
...
print str(len(tracts.records())) + " tracts mapped."
...
for row in data:
    ...
    for xy in dataIndies:
        print "finding area for point: " + newRow[xy[0]]+ "," + newRow[xy[1]] 
        ...
        #get the county
        found_county = findCounty(newRow[xy[0]],newRow[xy[1]], counties.shapeRecords())
        print "Found county: " + found_county
        newRow.append(found_county)        

        found_tract = findTract(newRow[xy[0]],newRow[xy[1]],tracts.shapeRecords(), countiesToTracts[found_county])
        print "Found tract: " + found_tract
        newRow.append(found_tract)

        found_block = findBlock(,newRow[xy[0]],newRow[xy[1]], blocks.shapeRecords(), tractsToBlocks[found_tract])
